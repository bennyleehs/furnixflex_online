  ...
  const generatePDF = async () => {
    ...
    try {
      ...
      const pdfData = {
        ...
        company1: {
          name: hqBranch?.company_name || "",
          regNo: hqBranch?.company_reg || "",
          ...
          tel: hqBranch?.phone || "",
          email: hqBranch?.email || "",
          website: hqBranch?.website || "",
          branches: hqBranch?.name || "",
      ...
      <div className="grid grid-cols-1 gap-8">
        ...
        <div className="border-stroke shadow-default dark:border-strokedark dark:bg-boxdark rounded-xs border bg-white p-6">
          ...
          <div className="mb-8">
            ...
            <div className="border-stroke dark:border-strokedark relative overflow-x-auto rounded-lg border">

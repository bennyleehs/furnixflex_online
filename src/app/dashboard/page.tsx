  ...
  return (
    <>
      ...
      <DefaultLayout>
        ...
        {/* Project Timeline */}
        <div className="border-stroke shadow-default dark:border-strokedark dark:bg-boxdark mb-6 rounded-lg border bg-white p-6">
          <h4 className="mb-6 text-xl font-semibold text-black dark:text-white">
            Project Timeline
          </h4>
            ...
            <ul className="list-inside list-disc space-y-2 pl-2">
              ...
              <li className="font-medium">
                ...
                <ul className="list-circle mt-1 mb-2 ml-6 list-inside text-sm font-normal text-gray-600 dark:text-gray-400">
                  ...
                  <li>
                    Resolve data inconsistency between snake_case and camelCase
                    properties
                  </li>

...
export default function Home() {
  ...
  const [projectPhases, setProjectPhases] = useState([
    {
      ...
      tasks: [
        ...
        { name: "Transaction Flow Implementation", status: "completed", dueDate: "2025-06-15" }
      ]
    },
    {
  ...
  const [salesStats, setSalesStats] = useState({ drafts: 18, sent: 24, accepted: 14, rejected: 6 });
  
  // Job statistics
  const [jobStats, setJobStats] = useState({ expired: 5, nearExpiry: 12, active: 28 });
  
  // Calculate overall project progress
  const overallProgress = Math.round(projectPhases.reduce((acc, phase) => acc + phase.progress, 0) / projectPhases.length);
  ...
  const salesChartData = {
    ...
    datasets: [
      {
        data: [salesStats.drafts, salesStats.sent, salesStats.accepted, salesStats.rejected],
            ...
            <div className="rounded-xs border border-stroke bg-white py-6 px-7.5 shadow-default dark:border-strokedark dark:bg-boxdark">
              <div className="flex items-center justify-between">
                ...
                <div className="flex h-12 w-12 items-center justify-center rounded-full bg-meta-2 dark:bg-meta-4">
                  <svg className="fill-primary dark:fill-white" width="24" height="24" viewBox="0 0 24 24">
                    <path d="M12,4V2A10,10 0 0,0 2,12H4A8,8 0 0,1 12,4Z"></path>
                    <path d="M12,20V22A10,10 0 0,0 22,12H20A8,8 0 0,1 12,20Z" opacity="0.5"></path>
                  </svg>
                </div>
              </div>
            </div>
            ...
            <div className="rounded-xs border border-stroke bg-white py-6 px-7.5 shadow-default dark:border-strokedark dark:bg-boxdark">
              <div className="flex items-center justify-between">
                <div>
                  ...
                  <span className="text-sm font-medium">Days Until Completion</span>
                </div>
                <div className="flex h-12 w-12 items-center justify-center rounded-full bg-meta-2 dark:bg-meta-4">
                  <svg className="fill-primary dark:fill-white" width="24" height="24" viewBox="0 0 24 24">
              ...
              <table className="w-full table-auto">
                <thead>
                  <tr className="bg-gray-2 text-left dark:bg-meta-4">
                    <th className="py-4 px-4 font-medium text-black dark:text-white">Phase</th>
                    ...
                    <th className="py-4 px-4 font-medium text-black dark:text-white">Key Tasks</th>
                  </tr>
                </thead>
                <tbody>
                  {projectPhases.map((phase, index) => (
                    <tr key={index} className="border-b border-stroke dark:border-strokedark">
                      <td className="py-5 px-4">
                        <h5 className="font-medium text-black dark:text-white">{phase.name}</h5>
                      </td>
                      <td className="py-5 px-4">
                      ...
                      <td className="py-5 px-4">
                        <div className="w-full h-2 bg-gray-2 rounded-full dark:bg-meta-4">
                          <div 
                            className="h-full bg-primary rounded-full"
                            style={{ width: `${phase.progress}%` }}
                          ></div>
                        </div>
                        <p className="mt-1 text-xs text-right">{phase.progress}%</p>
                      </td>
                      <td className="py-5 px-4">
            ...
            <div>
              ...
              <div className="overflow-x-auto">
                <table className="w-full table-auto">
                  <thead>
                    <tr className="bg-gray-2 text-left dark:bg-meta-4">
                      <th className="py-3 px-4 font-medium text-black dark:text-white">Week</th>
                      <th className="py-3 px-4 font-medium text-black dark:text-white">Focus</th>
                      <th className="py-3 px-4 font-medium text-black dark:text-white">Deliverables</th>
                    </tr>
                  </thead>
                  <tbody>
                    ...
                    <tr className="border-b border-stroke dark:border-strokedark">
                      ...
                      <td className="py-3 px-4">PDF Generation</td>
                      <td className="py-3 px-4">Complete PDF generation and email functionality</td>
                    </tr>
                    <tr className="border-b border-stroke dark:border-strokedark">
                    ...
                    <tr className="border-b border-stroke dark:border-strokedark">
                      ...
                      <td className="py-3 px-4">Develop payment tracking system</td>
                    </tr>
                    <tr>
                      <td className="py-3 px-4 text-black dark:text-white">Week 5</td>
                      <td className="py-3 px-4">Testing</td>
                      <td className="py-3 px-4">Testing and bug fixes for core functionality</td>
                    </tr>
                  </tbody>
                </table>
              </div>

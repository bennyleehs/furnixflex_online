            ...
            <div className="mb-4">
              <div className="relative">
                ...
                <input
                  ...
                  id="uid"
                  placeholder=" "
                  className="peer focus:border-primary w-full rounded-lg border border-neutral-300 bg-white py-3 pr-10 pl-10 text-black uppercase focus:outline-none"
                  value={uid}
                ...
                <label
                  htmlFor="uid"
                  className="peer-focus:text-primary peer-[&:not(:placeholder-shown)]:text-primary absolute top-2.5 left-10 z-10 origin-[0] bg-white/80 px-1 font-medium transition-all duration-300 ease-in-out peer-placeholder-shown:translate-y-0 peer-placeholder-shown:scale-100 peer-focus:-translate-y-5 peer-focus:scale-90 peer-[&:not(:placeholder-shown)]:-translate-y-5 peer-[&:not(:placeholder-shown)]:scale-90"
                >
                  User ID
                </label>

              ...
              <div className="mb-4">
                ...
                <div className="relative">
                  <input
                    type="text"
                    placeholder="UID"
                    className="w-full rounded-lg border border-stroke bg-transparent py-2 pl-6 pr-10 uppercase text-black outline-hidden focus:border-primary focus-visible:shadow-none dark:border-form-strokedark dark:bg-form-input dark:text-white dark:focus:border-primary"
                    disabled={false}
                    value={uid}

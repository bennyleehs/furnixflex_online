        ...
        <table className="w-full table-auto">
          <thead>
            <tr className="bg-gray-2 text-left dark:bg-meta-4">
              <th className="min-w-[200px] px-2 py-4 font-medium text-black dark:text-white xl:pl-8">
                Package
              </th>
              <th className="min-w-[200px] px-2 py-4 font-medium text-black dark:text-white xl:pl-8">
                Package 2
              ...
              <th className="min-w-[120px] px-2 py-4 font-medium text-black dark:text-white">
                Status
              </th>

    ...
    menuItems: [
      {
        ...
        disable: true,
        children: [
          { label: "Sales", route: "/dashboard/jobsReport" },
          { label: "Finance", route: "" },
          { label: "Admin", route: "/forms/form-layout" },
        ],
      },
      {
        icon: (
        ...
        route: "#",
        children: [
          { label: "Branches", route: "/admin/branch" },
          { label: "Human Resources", route: "#" ,
            children: [
              { label: "Departments", route: "/admin/department"}, 
              { label: "Roles", route: "/admin/role" },
              { label: "Employees", route: "/admin/employee" },
              { label: "Rules", route: "", 
                children: [
                  { label: "Clocks", route: "/admin/clock" },
                ],
              },
              { label: "Scopes", route: "/admin/scopes" },
            ],
          },
          { label: "Assets", route: "",
            children: [
              { label: "Propetys", route: "/admin/property"}, 
              { label: "Equiments", route: "/admin/equipment"}, 
              { label: "Inventory", route: "/admin/stock"}, 
            ]
          },
          { label: "Partners", route: "#", 
            children: [
              { label: "Dealers", route: "" },
              { label: "Designers", route: "" },
              { label: "Contractors", route: "" },
              { label: "Referrals", route: "" },
            ],
          },
        ],
      },
      {
        icon: (
          <svg
            ...
            viewBox="0 0 22 22"
            fill="none"
            stroke="currentColor" //similar to className="fill-current"
            strokeWidth="2"
            strokeLinecap="butt"
            strokeLinejoin="round"
          >
            <path d="M3 3v18h18" fill="" />
            <path d="M18.7 8l-5.1 5.2-2.8-2.7L7 14.3" fill="" />
          </svg>
        ),
        label: "Sales", route: "#",
        children: [
      ...
      },
      {
        ...
        label: "Finance", route: "#",
        children: [
          { label: "Commissionig Rules", route: "#" ,
            children: [
              { label: "Sales", route: "#",
                children: [
                  { label: "Indoor", route: "#" },
                  { label: "Measurement", route: "#" },
                ],
              },
              { label: "Dealer", route: "#",
                children: [
    ...
    <ClickOutside onClick={() => setSidebarOpen(false)}>
      ...
      >
        ...
        <div className="flex items-center justify-between gap-2 px-6 py-5 lg:py-6">
          <Link href="/">
            <Image
              width={170}
              height={20}
              src={"/images/logo/classy_logo_gray.svg"} //changes logo
              alt="Logo"
              priority
            />
          </Link>
        ...
        <div className="no-scrollbar flex flex-col overflow-y-auto duration-300 ease-linear">
          ...
          <p className="absolute bottom-5 left-1/2 -translate-x-1/2 whitespace-nowrap text-center text-sm text-gray-400">
